...
class Transaction(models.Model):
    ...
    principal=models.DecimalField(blank=True,max_digits=8,decimal_places=2)
    monthly_pay=models.DecimalField(blank=True,max_digits=8,decimal_places=2)
    duration=models.IntegerField(blank=True)
    affordability=models.DecimalField(blank=True,max_digits=8,decimal_places=2)
    application_date=models.DateField(blank=True)
    start_date=models.DateField(blank=True)
    transaction_type=models.CharField(max_length=80,choices=(('loan','Loan'),('insurance','Insurance')),blank=True)
    authorization_satus=models.BooleanField(blank=True)
    authorization_date=models.DateField(blank=True)
